...
namespace Tower_Defense.Prefabs
{
    public class PathNode : Entity
    {
        ...
        public PathNode(Vec2 pos, bool followMouse = true)
        {
            AddComponent(new Sprite("PathNodeTexture", new Vec2(15, 15), Color.White));
        ...
        private void OnClickLeft()
        {
            ...
            {
                followMouse = false;
                EditorManager.Instance.AddNode(NodeType.PathNode);
            }
            else
            {
                followMouse = true;
        ...
        private void OnClickRight()
        {
            if (followMouse)
            {
                EditorManager.Instance.RemoveNode(NodeType.PathNode, this);
